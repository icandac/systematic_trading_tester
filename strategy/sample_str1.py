...
def moving_average_crossover_signals(
    ...
    Returns:
      pd.DataFrame: DataFrame with additional columns for short and
                    long moving averages and signals.
    """
...
def generate_signals(df: pd.DataFrame):
    """
    Wrapper to call whichever strategies you want. Currently uses a simple MA crossover strategy.
    Args:
      df (pd.DataFrame): DataFrame containing the price data.
    Returns:
